    ...
    <div className="relative h-full min-h-130 w-full overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          animate={{ x: [-40, 40, -40], opacity: [0.25, 0.55, 0.25] }}
        ...
        <motion.div
          ...
          animate={{ x: [55, -35, 55], opacity: [0.18, 0.42, 0.18] }}
        ...
        <motion.div
          ...
          animate={{ x: [-25, 65, -25], opacity: [0.12, 0.32, 0.12] }}
      ...
      <div className="absolute right-0 inset-y-0 flex flex-col justify-between top-0 space-y-6 text-right">
                ...
                <div className="col-span-10">
                  ...
                  <div className="mt-5 max-w-[60ch] text-white/75 leading-relaxed space-y-3">
                    <p>
                      ...
                      terrain d’expression : comprendre, structurer, construire.
                    </p>
                    <p>
                      Très vite, créer des interfaces est devenu une évidence.
                    </p>
                  </div>
